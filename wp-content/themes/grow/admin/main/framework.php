...
//        require_once dirname( __FILE__ ) . '/inc/welcome/welcome.php';
        ...
        class ReduxFramework {
            ...
            public static $_version = '3.5.6.6';
            public static $_dir;
            public static $_url;
...
// ===============================================================
//	ThinkUpThemes - Custom Select Fields - START
// ===============================================================						
					else if ($type == "sidebars" || $type == "sidebar") {
						global $wp_registered_sidebars;
						$of_sidebars = array();
...
// ===============================================================
//	ThinkUpThemes - Custom Select Fields - END
// ===============================================================
                    }
                    //if
...
// show()
            ...
            private function add_submenu( $page_parent, $page_title, $menu_title, $page_permissions, $page_slug ) {
                ...
                if ( isset ( $test[ $page_parent ] ) ) {
                    ...
                    if ( true == $addMenu ) {
						// Code removed for compliance with Theme Check - ThinkUpThemes
                    }
                }
            }
            ...
            public function _admin_bar_menu() {
                ...
                if ( $menu ) {
                    ...
                    $nodeargs = array(
                        ...
                        'title' => $title,
                        // $theme_data->get( 'Name' ) . " " . __( 'Options', 'redux-framework' ),
...
// get_default_output_string()
            ...
            public function get_header_html( $field ) {
                ...
                if ( ( isset ( $field['title'] ) || isset ( $field['subtitle'] ) ) && isset ( $field['type'] ) && $field['type'] !== "info" && $field['type'] !== "section" ) {
