...
$thinkup_blog_style1layout = $thinkup_theme['thinkup_blog_style1layout'];
...
// Fetch individual values from theme options array
$thinkup_blog_postswitch   = $thinkup_theme['thinkup_blog_postswitch'];
$thinkup_blog_style1layout = $thinkup_theme['thinkup_blog_style1layout'];
...
$categories_list = get_the_category_list( __( ', ', 'grow' ) );
	...
	if ( $categories_list && thinkup_input_categorizedblog() ) {
		...
		printf( __( '%1$s', 'grow' ), $categories_list );
		echo	'</span>';
	};
}
...
// Fetch individual values from theme options array
$thinkup_translate_blogreadmore = $thinkup_theme['thinkup_translate_blogreadmore'];
...
$class_button = NULL;
	...
	return '...<p class="more-link"><a href="'. esc_url( get_permalink( $post->ID ) ) . '" class="' . esc_attr( $class_button ) . '">' . esc_html( $thinkup_translate_blogreadmore ) . '</a></p>';
}
...
// Fetch individual values from theme options array
$thinkup_post_authorbio = $thinkup_theme['thinkup_post_authorbio'];
