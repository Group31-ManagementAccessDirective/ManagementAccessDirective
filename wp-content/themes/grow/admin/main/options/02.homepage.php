...
// Get array of theme options
$thinkup_theme = get_option( 'thinkup_redux_variables' );

// Fetch individual values from theme options array
$thinkup_homepage_sliderswitch      = $thinkup_theme['thinkup_homepage_sliderswitch'];
$thinkup_homepage_sliderpresetwidth = $thinkup_theme['thinkup_homepage_sliderpresetwidth'];
...
// Fetch individual values from theme options array
$thinkup_homepage_sliderpage1 = $thinkup_theme['thinkup_homepage_sliderpage1'];
$thinkup_homepage_sliderpage2 = $thinkup_theme['thinkup_homepage_sliderpage2'];
$thinkup_homepage_sliderpage3 = $thinkup_theme['thinkup_homepage_sliderpage3'];
...
// Fetch individual values from theme options array
$thinkup_homepage_sliderswitch = $thinkup_theme['thinkup_homepage_sliderswitch'];
$thinkup_homepage_slidername   = $thinkup_theme['thinkup_homepage_slidername'];
$thinkup_homepage_sliderpage1  = $thinkup_theme['thinkup_homepage_sliderpage1'];
$thinkup_homepage_sliderpage2  = $thinkup_theme['thinkup_homepage_sliderpage2'];
$thinkup_homepage_sliderpage3  = $thinkup_theme['thinkup_homepage_sliderpage3'];
...
$slider_default          = NULL;
	...
	if ( is_front_page() or thinkup_check_ishome() ) {
		...
		// Set default slider
		$slider_default .= '<li><img src="' . get_template_directory_uri() . '/images/transparent.png" style="background: url(' . get_template_directory_uri() . '/images/slideshow/slide_demo1.png) no-repeat center; background-size: cover;" alt="' . esc_attr__( 'Demo Image', 'grow' ) . '" /></li>';
		$slider_default .= '<li><img src="' . get_template_directory_uri() . '/images/transparent.png" style="background: url(' . get_template_directory_uri() . '/images/slideshow/slide_demo2.png) no-repeat center; background-size: cover;" alt="' . esc_attr__( 'Demo Image', 'grow' ) . '" /></li>';
		$slider_default .= '<li><img src="' . get_template_directory_uri() . '/images/transparent.png" style="background: url(' . get_template_directory_uri() . '/images/slideshow/slide_demo3.png) no-repeat center; background-size: cover;" alt="' . esc_attr__( 'Demo Image', 'grow' ) . '" /></li>';
		...
		if ( current_user_can( 'edit_theme_options' ) and ( empty( $thinkup_homepage_sliderswitch ) or $thinkup_homepage_sliderswitch == 'option1' ) ) {
			...
			if( current_user_can( 'edit_theme_options' ) and ! is_numeric( $thinkup_homepage_sliderpage1 ) and ! is_numeric( $thinkup_homepage_sliderpage2 ) and ! is_numeric( $thinkup_homepage_sliderpage3 ) ) {
...
// Fetch individual values from theme options array
$thinkup_homepage_sliderpresetheight = $thinkup_theme['thinkup_homepage_sliderpresetheight'];
...
// Fetch individual values from theme options array
$thinkup_homepage_sectionswitch   = $thinkup_theme['thinkup_homepage_sectionswitch'];
$thinkup_homepage_section1_icon   = $thinkup_theme['thinkup_homepage_section1_icon'];
$thinkup_homepage_section1_title  = $thinkup_theme['thinkup_homepage_section1_title'];
$thinkup_homepage_section1_desc   = $thinkup_theme['thinkup_homepage_section1_desc'];
$thinkup_homepage_section1_link   = $thinkup_theme['thinkup_homepage_section1_link'];
$thinkup_homepage_section1_url    = $thinkup_theme['thinkup_homepage_section1_url'];
$thinkup_homepage_section1_button = $thinkup_theme['thinkup_homepage_section1_button'];
$thinkup_homepage_section2_icon   = $thinkup_theme['thinkup_homepage_section2_icon'];
$thinkup_homepage_section2_title  = $thinkup_theme['thinkup_homepage_section2_title'];
$thinkup_homepage_section2_desc   = $thinkup_theme['thinkup_homepage_section2_desc'];
$thinkup_homepage_section2_link   = $thinkup_theme['thinkup_homepage_section2_link'];
$thinkup_homepage_section2_url    = $thinkup_theme['thinkup_homepage_section2_url'];
$thinkup_homepage_section2_button = $thinkup_theme['thinkup_homepage_section2_button'];
$thinkup_homepage_section3_icon   = $thinkup_theme['thinkup_homepage_section3_icon'];
$thinkup_homepage_section3_title  = $thinkup_theme['thinkup_homepage_section3_title'];
$thinkup_homepage_section3_desc   = $thinkup_theme['thinkup_homepage_section3_desc'];
$thinkup_homepage_section3_link   = $thinkup_theme['thinkup_homepage_section3_link'];
$thinkup_homepage_section3_url    = $thinkup_theme['thinkup_homepage_section3_url'];
$thinkup_homepage_section3_button = $thinkup_theme['thinkup_homepage_section3_button'];
	...
	if ( current_user_can( 'edit_theme_options' ) ) {
		...
		if ( empty( $thinkup_homepage_section1_title ) ) $thinkup_homepage_section1_title = __( 'Perfect For All', 'grow' );
		if ( empty( $thinkup_homepage_section2_title ) ) $thinkup_homepage_section2_title = __( '100% Responsive', 'grow' );
		if ( empty( $thinkup_homepage_section3_title ) ) $thinkup_homepage_section3_title = __( 'Powerful Framework', 'grow' );

		// Set default values for descriptions
		if ( empty( $thinkup_homepage_section1_desc ) ) 
		$thinkup_homepage_section1_desc = __( 'Grow is the perfect choice for any website. Easy to use, stunning design and packed with awesome features. Create something amazing!', 'grow' );

		if ( empty( $thinkup_homepage_section2_desc ) ) 
		$thinkup_homepage_section2_desc = __( 'Grow is 100% mobile responsive. It looks great on all devices, from from mobiles to desktops, and everything in between!', 'grow' );

		if ( empty( $thinkup_homepage_section3_desc ) ) 
		$thinkup_homepage_section3_desc = __( 'Get a taste the awesome ThinkUpThemes Framework. Make changes without ever touching any code! Beautiful and powerful!', 'grow' );
...
// Fetch individual values from theme options array
$thinkup_homepage_introswitch        = $thinkup_theme['thinkup_homepage_introswitch'];
$thinkup_homepage_introaction        = $thinkup_theme['thinkup_homepage_introaction'];
$thinkup_homepage_introactionteaser  = $thinkup_theme['thinkup_homepage_introactionteaser'];
$thinkup_homepage_introactiontext1   = $thinkup_theme['thinkup_homepage_introactiontext1'];
$thinkup_homepage_introactionlink1   = $thinkup_theme['thinkup_homepage_introactionlink1'];
$thinkup_homepage_introactionpage1   = $thinkup_theme['thinkup_homepage_introactionpage1'];
$thinkup_homepage_introactioncustom1 = $thinkup_theme['thinkup_homepage_introactioncustom1'];
