...
function thinkup_custom_logo() {
	...
	$check_logoset = esc_url( wp_get_attachment_image_src( get_theme_mod( 'custom_logo' ), 'full' ) );
...
$thinkup_homepage_layout           = $thinkup_theme['thinkup_homepage_layout'];
$thinkup_general_layout            = $thinkup_theme['thinkup_general_layout'];
$thinkup_blog_layout               = $thinkup_theme['thinkup_blog_layout'];
$thinkup_post_layout               = $thinkup_theme['thinkup_post_layout'];
$thinkup_portfolio_layout          = $thinkup_theme['thinkup_portfolio_layout'];
$thinkup_project_layout            = $thinkup_theme['thinkup_project_layout'];
$thinkup_woocommerce_layout        = $thinkup_theme['thinkup_woocommerce_layout'];
$thinkup_woocommerce_layoutproduct = $thinkup_theme['thinkup_woocommerce_layoutproduct'];
...
// Fetch individual values from theme options array
$thinkup_general_sidebars            = $thinkup_theme['thinkup_general_sidebars'];
$thinkup_homepage_sidebars           = $thinkup_theme['thinkup_homepage_sidebars'];
$thinkup_blog_sidebars               = $thinkup_theme['thinkup_blog_sidebars'];
$thinkup_post_sidebars               = $thinkup_theme['thinkup_post_sidebars'];
$thinkup_portfolio_sidebars          = $thinkup_theme['thinkup_portfolio_sidebars'];
$thinkup_project_sidebars            = $thinkup_theme['thinkup_project_sidebars'];
$thinkup_woocommerce_sidebars        = $thinkup_theme['thinkup_woocommerce_sidebars'];
$thinkup_woocommerce_sidebarsproduct = $thinkup_theme['thinkup_woocommerce_sidebarsproduct'];
...
// Fetch individual values from theme options array
$thinkup_general_introswitch      = $thinkup_theme['thinkup_general_introswitch'];
$thinkup_general_breadcrumbswitch = $thinkup_theme['thinkup_general_breadcrumbswitch'];
...
// Fetch individual values from theme options array
$thinkup_general_fixedlayoutswitch = $thinkup_theme['thinkup_general_fixedlayoutswitch'];
...
// Fetch individual values from theme options array
$thinkup_general_customcss = $thinkup_theme['thinkup_general_customcss'];
